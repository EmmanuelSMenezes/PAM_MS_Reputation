...
MicroserviÃ§o para **sistema de avaliaÃ§Ãµes e reputaÃ§Ã£o**. Gerencia ratings, reviews detalhados, comentÃ¡rios, sistema de pontuaÃ§Ã£o de parceiros e serviÃ§os, moderaÃ§Ã£o de conteÃºdo, anÃ¡lise de sentimento e ranking de qualidade.

### ðŸŽ¯ Principais Funcionalidades

- â­ **AvaliaÃ§Ãµes**: Sistema de rating 1-5 estrelas
- ðŸ’¬ **Reviews**: ComentÃ¡rios detalhados
- ðŸ† **Rankings**: ClassificaÃ§Ã£o de parceiros
- ðŸ” **ModeraÃ§Ã£o**: Filtro de conteÃºdo
- ðŸ“Š **Analytics**: AnÃ¡lise de sentimento
- ðŸŽ¯ **RecomendaÃ§Ãµes**: SugestÃµes baseadas em rating
- ðŸ“ˆ **TendÃªncias**: EvoluÃ§Ã£o da reputaÃ§Ã£o
- ðŸš« **DenÃºncias**: Sistema de reports
...
{
  "ConnectionStrings": {
    "DefaultConnection": "Server=localhost;Database=PAM_PAM_MS_Reputation;Trusted_Connection=true;MultipleActiveResultSets=true"
  }
}
`
...
`ash
# Build da imagem
docker build -t PAM_MS_Reputation.ToLower() .
...
- **Local**: http://localhost:5011/swagger
- **ProduÃ§Ã£o**: https://api.pam.com/PAM_MS_Reputation.ToLower()/swagger
...
curl -X POST "http://localhost:5011/api/v1/auth/login" \
...
curl -X GET "http://localhost:5011/api/v1/..." \
...
az webapp deploy --resource-group PAM --name PAM_MS_Reputation --src-path ./publish
`
...
`ash
# Tag da imagem
docker tag PAM_MS_Reputation.ToLower() registry.azurecr.io/pam/PAM_MS_Reputation.ToLower():latest

# Push para registry
docker push registry.azurecr.io/pam/PAM_MS_Reputation.ToLower():latest
`
...
- **ðŸ› Issues**: [GitHub Issues](https://github.com/EmmanuelSMenezes/PAM_MS_Reputation/issues)
- **ðŸ“– Wiki**: [DocumentaÃ§Ã£o Completa](https://github.com/EmmanuelSMenezes/PAM_MS_Reputation/wiki)
...
**[â¬† Voltar ao Topo](#-PAM_MS_Reputation)**
