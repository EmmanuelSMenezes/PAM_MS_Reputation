...
MicroserviÃ§o para sistema de avaliaÃ§Ãµes e reputaÃ§Ã£o. Gerencia ratings, reviews, comentÃ¡rios e sistema de pontuaÃ§Ã£o de parceiros e serviÃ§os.
...
2. **Execute o container**
   `ash
   docker run -p 5011:5011 -e ConnectionStrings__DefaultConnection="sua-connection-string" PAM_MS_Reputation.ToLower()
   `

## ðŸ“š DocumentaÃ§Ã£o da API

A documentaÃ§Ã£o completa da API estÃ¡ disponÃ­vel via Swagger UI:
- **Desenvolvimento**: http://localhost:5011/swagger
